...
REM
REM Generated by Vivado on Wed Jun 03 14:40:43 +0530 2026
...
echo "xvlog --incr --relax -prj tb_ALU_topmodule_vlog.prj"
call xvlog  --incr --relax -prj tb_ALU_topmodule_vlog.prj -log xvlog.log
